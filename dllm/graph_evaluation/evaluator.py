...
class Evaluator:
    ...
    def __call__(
        ...
        degree_mmd_stats = DegreeMMD()(
            gen_graphs=nx_graphs, train_graphs=train_nx_graphs
        )
    ...
    def graph_stats(self, graphs: Sequence[nx.Graph]) -> dict[str, float | int]:
        ...
        avg_largest_connected_component_size = (
            sum(graph_largest_component_sizes) / total_graphs
        )
