...
class TrainingArguments(dllm.core.trainers.MDLMConfig):
    ...
    graph_eval_generation_batch_size: int = 1
    graph_eval_num_generated_graphs: int = 16
    graph_eval_steps: int = 64
    graph_eval_max_new_tokens: int = 256
    graph_eval_block_size: int = 32
    graph_eval_temperature: float = 0.1
...
def build_token_dataset_text_dict(
    ...
    *,
    ...
    receive labels=-100 so the MDLMTrainer never masks or trains on them.
    """
...
def train():
    ...
    with accelerate.PartialState().local_main_process_first():
        ...
        # --- Check model context size vs actual tokenized sequence lengths ---
        try:
...
# GRAPH_FORMAT_PROMPT = (
#     "A graph is represented as an adjacency dictionary where each key is a node index "
#     "and its value is a list of neighboring node indices. "
#     "Generate a valid graph in this format:"
# )

# def build_token_dataset_new(
#     graphs,
#     strategy,
#     tokenizer,
#     max_length: int | None = None,
#     test_size: float = 0.1,
#     seed: int = 42,
#     prompt: str = GRAPH_FORMAT_PROMPT,
# ) -> datasets.DatasetDict:
#     rows = build_dataset_from_pyg_graphs(
#         graphs,
#         strategy,
